...
\quickfig{\columnwidth}{guitar.pdf}{A guitar. (a) The instrument has six strings, each fixed at their endpoints. (b) The possible vibration shapes of the strings have $1, 2, 3,\ldots$ waves. (c) The sequence of shapes experienced by the string, started in the black shape, as it vibrates. (d) The sequence of shapes experienced by the string, started in the blue shape, as it vibrates.}{fig:guitar}
