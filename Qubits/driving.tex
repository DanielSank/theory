...
Noting that the wave functions of a one-dimensional quantum Hamiltonian are real and that $Q = -i \hbar d/d\Phi$, we can express the drive Hamiltonian as
\begin{align*}
  H_d
  &= \frac{V_d(t)}{1 + C / C_d}
    \left[ \begin{array}{cc}
  ...
  \right)
\end{align*}
where $S \equiv \bbraket{0}{Q}{0} + \bbraket{1}{Q}{1}$ and $\Delta \equiv \bbraket{0}{Q}{0} - \bbraket{1}{Q}{1}$.
