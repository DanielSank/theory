\levelstay{Decoherence and control}
...
\begin{center}
  ...
  \end{tabular}
\end{center}
Using the forms of $h_d$, $Q_\text{zpf}$ and $\Phi_\text{zpf}$, we can rewrite $h_d$ as
\begin{align*}
...
In the case of a nearly harmonic qubit like the transmon, the effect of dissipation from the drive line is can be computed from classical electronics arguments.
...
\begin{equation}
  \Delta t = \frac{\pi}{2} \sqrt{ \frac{Q_d \hbar}{P_a}} \, .
\end{equation}
Combining these results gives the universal design rule
\begin{equation}
  \Gamma \Delta t = \frac{\pi}{2} \frac{\Seng_a}{\sqrt{Q_d \hbar P_a}} \, .
\end{equation}
