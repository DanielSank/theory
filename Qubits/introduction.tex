...
Reference \cite{Vool:quantum_electromagnetics:2017}, which develops the quantization of arbitrary lumped-element electrical circuits, including a discussion of dissipative elements, is an excellent starting point and could be seen as a prerequisite for this work.\footnote{Ref. \cite{Vool:quantum_electromagnetics:2017} is a spiritual rewrite of an earlier \mbox{\href{http://qulab.eng.yale.edu/documents/reprints/Houches_fluctuations.pdf}{set of course notes}} for the Les Houches school, written by Michel Devoret. Among other things, the rewrite corrects several unfortunate typos from the original.}
In other words, Reference \cite{Vool:quantum_electromagnetics:2017} tells you how to write the Hamiltonian for a given electrical circuit.
