...
The Hamiltonian is the total energy expressed in terms of the coordinate $\Phi$ and it's conjugate momentum $Q$.
...
The quantum harmonic oscillator is studied in e.g. \citeinternaltype \citeinternalref{quantumOscillator} where it is found that the Hamiltonian can be re-expressed as
\begin{align}
